...
Usage is pretty simple. Instantiate the package with your information. Use the predefined container functions `definition`, `example`, and `recipe` to build up your cheatsheet. The `grid` function allows for sleek tables.ge.
